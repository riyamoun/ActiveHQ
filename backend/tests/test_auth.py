...
class TestAuthRefresh:
    ...
    def test_refresh_token_success(self, client: TestClient, owner_token: str):
...
class TestAuthLogout:
    ...
    def test_logout_success(self, client: TestClient, test_owner_user, db_session):
        """Logout successfully."""

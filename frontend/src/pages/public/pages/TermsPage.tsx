  ...
  return (
    <div className="max-w-3xl mx-auto px-8 py-20">
      ...
      <div className="prose prose-slate max-w-none space-y-6 text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-slate-800 mt-8">2. Service Description</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-800 mt-8">3. Account Responsibilities</h2>
        ...
        <h2 className="text-xl font-semibold text-slate-800 mt-8">4. Acceptable Use</h2>
        ...
        <h2 className="text-xl font-semibold text-slate-800 mt-8">5. Subscription &amp; Payments</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-800 mt-8">6. Data Ownership</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-800 mt-8">7. Service Availability</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-800 mt-8">8. Termination</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-800 mt-8">9. Contact</h2>
        <p>
